...
# Average CV score on the training set was: 0.901060606060606
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVC(C=5.0, dual=False, loss="squared_hinge", penalty="l2", tol=1e-05)),
    RobustScaler(),
    StackingEstimator(estimator=LinearSVC(C=25.0, dual=False, loss="squared_hinge", penalty="l2", tol=1e-05)),
