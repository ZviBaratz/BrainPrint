...
# Average CV score on the training set was: 0.8674242424242425
exported_pipeline = make_pipeline(
    ...
    RandomForestClassifier(bootstrap=True, criterion="entropy", max_features=0.7000000000000001, min_samples_leaf=20, min_samples_split=14, n_estimators=100)
)
