...
# Average CV score on the training set was: 0.8781060606060607
exported_pipeline = make_pipeline(
    ...
    XGBClassifier(learning_rate=0.1, max_depth=5, min_child_weight=5, n_estimators=100, n_jobs=1, subsample=0.6500000000000001, verbosity=0)
)
